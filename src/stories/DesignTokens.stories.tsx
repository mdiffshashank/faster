...
const colorTokens = [
  ...
  {
    name: "bg-brand-hover",
    cssVar: "--color-bg-primary-hover",
    label: "Brand Hover",
    category: "Brand"
  },
  {
    name: "bg-brand-subtle",
    cssVar: "--color-bg-primary-subtle",
    label: "Brand Subtle",
    category: "Brand"
  },
  // Surface
  ...
  {
    name: "bg-disabled-text",
    cssVar: "--color-disabled-text",
    label: "Disabled Text",
    category: "Disabled"
  },
  {
    name: "bg-disabled-border",
...
const typographyTokens = [
  {
    label: "H1 / Medium",
    cls: "text-3xl font-medium leading-tight",
    sample: "The quick brown fox"
  },
  {
    label: "Title / Medium",
    cls: "text-lg font-medium leading-tight",
    sample: "The quick brown fox"
  },
  {
    label: "Subtitle / Medium",
    cls: "text-base font-medium leading-normal",
    sample: "The quick brown fox"
  },
  {
    label: "Body / Medium",
  ...
  {
    label: "Body / Regular",
    cls: "text-sm font-normal leading-snug",
    sample: "The quick brown fox"
  },
  {
    label: "Caption / Regular",
    cls: "text-xs font-normal leading-snug",
    sample: "The quick brown fox"
  }
];
          ...
          <div className="flex flex-wrap gap-6">
            {elevationTokens.map((e) => (
              <div key={e.name} className="flex flex-col gap-3 items-center">
                <div className={`${e.name} h-16 w-24 rounded-lg bg-surface`} />
...
export const AllTokens: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Visual reference showing all colour swatches, typography scale, and elevation levels."
      }
    }
  }
};
